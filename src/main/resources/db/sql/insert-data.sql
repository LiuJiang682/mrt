...
INSERT INTO lOC_SITE(LOADER_ID, SITE_ID, GSV_SITE_ID, PARISH, PROSPECT, AMG_ZONE, EASTING, NORTHING, LATITUDE, LONGITUDE, LOCN_ACC, LOCN_DATUM_CD, ELEVATION_GL, ELEV_ACC, ELEV_DATUM_CD, COORD_SYSTEM, VERTICAL_DATUM, NUM_DATA_RECORDS, ISSUE_COLUMN_INDEX, FILE_NAME) 
    values (1, 'KPDD001', 0, 'N/A', 'Kryptonite', 55, 392200, 6589600, 0, 0, 0, 'GDA94', 0, 0, 'AHD', null, null, -1, -1, 'myTest.txt');
    
INSERT INTO lOC_SITE(LOADER_ID, SITE_ID, GSV_SITE_ID, PARISH, PROSPECT, AMG_ZONE, EASTING, NORTHING, LATITUDE, LONGITUDE, LOCN_ACC, LOCN_DATUM_CD, ELEVATION_GL, ELEV_ACC, ELEV_DATUM_CD, COORD_SYSTEM, VERTICAL_DATUM, NUM_DATA_RECORDS, ISSUE_COLUMN_INDEX, FILE_NAME) 
    values (12, 'KPDD001', 0, 'N/A', 'Kryptonite', 55, 392200, 6589600, 0, 0, 0, 'GDA94', 0, 0, 'AHD', null, null, -1, -1, 'myTest.txt');    
    
INSERT INTO lOC_SITE(LOADER_ID, SITE_ID, GSV_SITE_ID, PARISH, PROSPECT, AMG_ZONE, EASTING, NORTHING, LATITUDE, LONGITUDE, LOCN_ACC, LOCN_DATUM_CD, ELEVATION_GL, ELEV_ACC, ELEV_DATUM_CD, COORD_SYSTEM, VERTICAL_DATUM, NUM_DATA_RECORDS, ISSUE_COLUMN_INDEX, FILE_NAME) 
    values (12, 'KPDD002', 0, 'N/A', 'Kryptonite', 55, 392200, 6589600, 0, 0, 0, 'GDA94', 0, 0, 'AHD', null, null, -1, -1, 'myTest.txt');        
    
INSERT INTO DH_BOREHOLE(LOADER_ID, HOLE_ID, BH_AUTHORITY_CD, BH_REGULATION_CD, DILLING_DETAILS_ID, DRILLING_START_DT, DRILLING_COMPLETION_DT, DEPTH, ELEVATION_KB, AZIMUTH_MAG, BH_CONFIDENTIAL_FLG, DEPTH_UOM, FILE_NAME) 
    values (1, 'KPDD001', 'U', 'N/A', 1, sysdate, sysdate, 210, 320, null, 'Y', 'MTR', 'myTest.txt');    
    
INSERT INTO DH_BOREHOLE(LOADER_ID, HOLE_ID, BH_AUTHORITY_CD, BH_REGULATION_CD, DILLING_DETAILS_ID, DRILLING_START_DT, DRILLING_COMPLETION_DT, DEPTH, ELEVATION_KB, AZIMUTH_MAG, BH_CONFIDENTIAL_FLG, DEPTH_UOM, FILE_NAME) 
    values (12, 'KPDD001', 'U', 'N/A', 1, sysdate, sysdate, 210, 320, null, 'Y', 'MTR', 'myTest.txt'); 

INSERT INTO DH_BOREHOLE(LOADER_ID, HOLE_ID, BH_AUTHORITY_CD, BH_REGULATION_CD, DILLING_DETAILS_ID, DRILLING_START_DT, DRILLING_COMPLETION_DT, DEPTH, ELEVATION_KB, AZIMUTH_MAG, BH_CONFIDENTIAL_FLG, DEPTH_UOM, FILE_NAME) 
    values (12, 'KPDD002', 'U', 'N/A', 1, sysdate, sysdate, 210, 320, null, 'Y', 'MTR', 'myTest.txt'); 
...
INSERT INTO DH_SURFACE_GEOCHEMISTRY(ID, LOADER_ID, SAMPLE_ID, FILE_NAME, EASTING, NORTHING, SAMPLE_TYPE, AMG_ZONE, ISSUE_COLUMN_INDEX)
    VALUES (1, 1, 'KPDD001', 'myTest.txt', 0, 1, 'DD', 54, -1);    
...
INSERT INTO DH_OPTIONAL_FIELDS(ID, LOADER_ID, FILE_NAME, TEMPLATE_NAME, TEMPLATE_HEADER, ROW_NUMBER, FIELD_VALUE) 
    VALUES (8, 100, 'myTest.txt', 'DS4', 'H1000', 'H1000', 'Hole_id,Sureryed_Depth,Azimuth_Mag,Dip,Azimuth_True');  
