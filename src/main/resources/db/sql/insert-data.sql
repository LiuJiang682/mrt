...
INSERT INTO SESSION_HEADER(ID, TEMPLATE, PROCESS_DATE, TENEMENT, TENEMENT_HOLDER, REPORTING_DATE, PROJECT_NAME, STATUS, COMMENTS, EMAIL_SENT) 
    values (100, 'MRT', sysdate, 'abc', 'def', sysdate, 'ghi', 'running', '', 'N');   
