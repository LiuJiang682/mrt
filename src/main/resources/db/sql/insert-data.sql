...
INSERT INTO template_config VALUES (1, 'MRT', 'SL4:au.gov.vic.ecodev.mrt.template.processor.sl4.Sl4TemplateProcessor,DS4:au.gov.vic.ecodev.mrt.template.processor.ds4.Ds4TemplateProcessor,DL4:au.gov.vic.ecodev.mrt.template.processor.dl4.Dl4TemplateProcessor,DG4:au.gov.vic.ecodev.mrt.template.processor.dg4.Dg4TemplateProcessor,SG4:au.gov.vic.ecodev.mrt.template.processor.sg4.Sg4TemplateProcessor', 'jiang.liu@ecodev.vic.gov.au', 'au.gov.vic.ecodev.mrt.mail.MrtEmailBodyBuilder');
INSERT INTO template_config VALUES (2, 'VGPHYDRO', 'VGPHYDRO:au.gov.vic.ecodev.template.processor.custom.vgp.hydro.VgpHydroCustomProcessor', 'jiang.liu@ecodev.vic.gov.au','au.gov.vic.ecodev.template.mail.custom.vgp.hydro.VgpHydroEmailBodyBuilder');
...
INSERT INTO lOC_SITE(LOADER_ID, SITE_ID, GSV_SITE_ID, PARISH, PROSPECT, AMG_ZONE, EASTING, NORTHING, LATITUDE, LONGITUDE, LOCN_ACC, LOCN_DATUM_CD, ELEVATION_GL, ELEV_ACC, ELEV_DATUM_CD, COORD_SYSTEM, VERTICAL_DATUM, NUM_DATA_RECORDS, ISSUE_COLUMN_INDEX) 
    values (1, 'KPDD001', 0, 'N/A', 'Kryptonite', 55, 392200, 6589600, 0, 0, 0, 'GDA94', 0, 0, 'AHD', null, null, -1, -1);
    
INSERT INTO lOC_SITE(LOADER_ID, SITE_ID, GSV_SITE_ID, PARISH, PROSPECT, AMG_ZONE, EASTING, NORTHING, LATITUDE, LONGITUDE, LOCN_ACC, LOCN_DATUM_CD, ELEVATION_GL, ELEV_ACC, ELEV_DATUM_CD, COORD_SYSTEM, VERTICAL_DATUM, NUM_DATA_RECORDS, ISSUE_COLUMN_INDEX) 
    values (12, 'KPDD001', 0, 'N/A', 'Kryptonite', 55, 392200, 6589600, 0, 0, 0, 'GDA94', 0, 0, 'AHD', null, null, -1, -1);    
    
INSERT INTO lOC_SITE(LOADER_ID, SITE_ID, GSV_SITE_ID, PARISH, PROSPECT, AMG_ZONE, EASTING, NORTHING, LATITUDE, LONGITUDE, LOCN_ACC, LOCN_DATUM_CD, ELEVATION_GL, ELEV_ACC, ELEV_DATUM_CD, COORD_SYSTEM, VERTICAL_DATUM, NUM_DATA_RECORDS, ISSUE_COLUMN_INDEX) 
    values (12, 'KPDD002', 0, 'N/A', 'Kryptonite', 55, 392200, 6589600, 0, 0, 0, 'GDA94', 0, 0, 'AHD', null, null, -1, -1);        
