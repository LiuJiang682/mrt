...
INSERT INTO DH_SURFACE_GEOCHEMISTRY(ID, LOADER_ID, SAMPLE_ID, EASTING, NORTHING, SAMPLE_TYPE)
    VALUES (1, 1, 'KPDD001', 0, 1, 'DD');    
...
INSERT INTO SESSION_HEADER(ID, TEMPLATE, FILE_NAME, PROCESS_DATE, TENEMENT, TENEMENT_HOLDER, REPORTING_DATE, PROJECT_NAME, STATUS, COMMENTS, EMAIL_SENT) 
    values (100, 'MRT', 'MRT_EL123.zip', sysdate, 'abc', 'def', sysdate, 'ghi', 'running', '', 'N');   
