...
CREATE TABLE lOC_SITE (
    ...
    LOCN_DATUM_CD VARCHAR(5) DEFAULT '0' NOT NULL, 
    ELEVATION_GL DECIMAL DEFAULT null, 
    ELEV_ACC DECIMAL DEFAULT null, 
    ELEV_DATUM_CD VARCHAR(5) DEFAULT 'UNK' NOT NULL, 
    COORD_SYSTEM VARCHAR(20), 
    VERTICAL_DATUM VARCHAR(25), 
    NUM_DATA_RECORDS int NOT NULL,
    FILE_NAME VARCHAR(50) NOT NULL,
    ISSUE_COLUMN_INDEX int DEFAULT -1,
    UWI VARCHAR(250) DEFAULT NULL,
    LOCN_NAME VARCHAR(250) DEFAULT NULL,
    LOCN_DESC VARCHAR(250) DEFAULT NULL,
    STATE VARCHAR(25) DEFAULT NULL,
    BORE_DIAMETER DECIMAL DEFAULT 0,
    TD DECIMAL DEFAULT 0,
    TVD DECIMAL DEFAULT 0,
    DEPTH_DATUM VARCHAR(5) DEFAULT NULL,
);
...
(
    ID BIGINT NOT NULL, 
    LOADER_ID BIGINT DEFAULT NULL NOT NULL,
    TEMPLATE_NAME VARCHAR2(1250) DEFAULT NULL NOT NULL, 
    FILE_NAME VARCHAR(50) NOT NULL,
