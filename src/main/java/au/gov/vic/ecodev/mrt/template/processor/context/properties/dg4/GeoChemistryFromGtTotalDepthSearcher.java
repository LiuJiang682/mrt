...
public class GeoChemistryFromGtTotalDepthSearcher implements TemplateSearcher {

	private static final String SQL = "SELECT gc.HOLE_ID FROM DH_GEOCHEMISTRY gc, DH_BOREHOLE bh WHERE gc.HOLE_ID = bh.HOLE_ID AND gc.LOADER_ID = bh.LOADER_ID and gc.SAMPLE_FROM > bh.depth and gc.LOADER_ID = ?";
