...
public class H0202Validator implements Validator {
	...
	private static final String DATA_FORMAT_DL4 = "dl4";
	...
	public Optional<List<String>> validate(Map<String, List<String>> templateParamMap, Template dataBean) {
		...
		if (null == strs) {
			...
			if (!DATA_FORMAT_DL4.equalsIgnoreCase(strs[Numeral.TWO])) {
				String message = "H0202 must be DL4, but got " + strs[Numeral.TWO];
				messages.add(message);
			}
