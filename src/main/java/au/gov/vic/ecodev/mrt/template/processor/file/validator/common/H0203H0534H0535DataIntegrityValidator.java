...
public class H0203H0534H0535DataIntegrityValidator {
	...
	public final Template doFileDataIntegrityCheck(final Map<String, List<String>> templateParamMap, 
		...
		if (null == templateParamMap) {
			...
			new MandatoryRowChecker(templateParamMap.get(Strings.KEY_H0534), 
					Strings.KEY_H0534).validate(messages);

			new MandatoryRowChecker(templateParamMap.get(Strings.KEY_H0535), 
					Strings.KEY_H0535).validate(messages);
		}
