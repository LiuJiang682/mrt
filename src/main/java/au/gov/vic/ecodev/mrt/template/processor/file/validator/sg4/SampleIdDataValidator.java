...
public class SampleIdDataValidator {
	...
	public SampleIdDataValidator(String[] strs, int lineNumber, List<String> columnHeaders,
	...
	public void validate(List<String> messages) {
		List<String> sampleIdLableList = templateParamMap.get(Sg4ColumnHeaders.SAMPLE_ID.getCode());
		if (CollectionUtils.isEmpty(sampleIdLableList)) {
			String message = new StringBuilder(Strings.LOG_ERROR_HEADER)
					...
					.append(Sg4ColumnHeaders.SAMPLE_ID.getCode())
