...
public class H0701Validator implements Validator {

	public static final String DESCRIPTION_TITLE = "Sample_Prep_Desc";
	private static final String FIELD_NAME = "H0701";
	...
	public Optional<List<String>> validate(Map<String, List<String>> templateParamMap, Template dataBean) {
		...
		new TemplateFieldBasicValidator(strs, DESCRIPTION_TITLE, FIELD_NAME)
				.validate(messages);
		new H0700FieldsArraySizeValidator(strs, templateParamMap).validate(messages);
