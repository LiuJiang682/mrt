...
//	
	...
	/**
	 * This is the temperately query
	 */
	private static final String GDA_94_TENMENT_LAT_LONG_SQL = "SELECT COUNT(*) FROM ER.MINTEN m WHERE m.TNO = ? AND MDSYS.SDO_CONTAINS(m.SHAPE, MDSYS.SDO_GEOMETRY(2001, 4283, MDSYS.SDO_POINT_TYPE(?, ?, NULL), NULL, NULL)) = 'TRUE'";
	private static final String MGA_54_NE_SQL = "SELECT COUNT(*) FROM ER.FR_FRAMEWORK_AREA_POLYGON f WHERE f.STATE = 'VIC' AND MDSYS.SDO_CONTAINS(f.SHAPE, MDSYS.SDO_GEOMETRY(2001, 28354, MDSYS.SDO_POINT_TYPE(?, ?, NULL), NULL, NULL)) = 'TRUE' ";
	private static final String MGA_55_NE_SQL = "SELECT COUNT(*) FROM ER.FR_FRAMEWORK_AREA_POLYGON f WHERE f.STATE = 'VIC' AND MDSYS.SDO_CONTAINS(f.SHAPE, MDSYS.SDO_GEOMETRY(2001, 28355, MDSYS.SDO_POINT_TYPE(?, ?, NULL), NULL, NULL)) = 'TRUE' ";
	private static final String GDA_94_LAT_LONG_SQL = "SELECT COUNT(*) FROM ER.FR_FRAMEWORK_AREA_POLYGON f WHERE MDSYS.SDO_CONTAINS(f.SHAPE, MDSYS.SDO_GEOMETRY(2001, 4283, MDSYS.SDO_POINT_TYPE(?, ?, NULL), NULL, NULL)) = 'TRUE' AND f.STATE = 'VIC'";
	private static final String AGD_54_NE_SQL = "SELECT COUNT(*) FROM ER.FR_FRAMEWORK_AREA_POLYGON f WHERE MDSYS.SDO_CONTAINS(f.SHAPE, MDSYS.SDO_GEOMETRY(2001, 20354, MDSYS.SDO_POINT_TYPE(?, ?, NULL), NULL, NULL)) = 'TRUE' AND f.STATE = 'VIC'";
	private static final String AGD_55_NE_SQL = "SELECT COUNT(*) FROM ER.FR_FRAMEWORK_AREA_POLYGON f WHERE MDSYS.SDO_CONTAINS(f.SHAPE, MDSYS.SDO_GEOMETRY(2001, 20355, MDSYS.SDO_POINT_TYPE(?, ?, NULL), NULL, NULL)) = 'TRUE' AND f.STATE = 'VIC'";
	private static final String MDA_54_TENMENT_NE_SQL = "SELECT COUNT(*) FROM ER.MINTEN m WHERE m.TNO = ? AND MDSYS.SDO_CONTAINS(m.SHAPE, MDSYS.SDO_GEOMETRY(2001, 28354, MDSYS.SDO_POINT_TYPE(?, ?, NULL), NULL, NULL)) = 'TRUE'";
	private static final String MDA_55_TENMENT_NE_SQL = "SELECT COUNT(*) FROM ER.MINTEN m WHERE m.TNO = ? AND MDSYS.SDO_CONTAINS(m.SHAPE, MDSYS.SDO_GEOMETRY(2001, 28355, MDSYS.SDO_POINT_TYPE(?, ?, NULL), NULL, NULL)) = 'TRUE'";
	private static final String AGD_54_TENMENT_NE_SQL = "SELECT COUNT(*) FROM ER.MINTEN m WHERE m.TNO = ? AND MDSYS.SDO_CONTAINS(m.SHAPE, MDSYS.SDO_GEOMETRY(2001, 20354, MDSYS.SDO_POINT_TYPE(?, ?, NULL), NULL, NULL)) = 'TRUE'";
	private static final String AGD_55_TENMENT_NE_SQL = "SELECT COUNT(*) FROM ER.MINTEN m WHERE m.TNO = ? AND MDSYS.SDO_CONTAINS(m.SHAPE, MDSYS.SDO_GEOMETRY(2001, 20355, MDSYS.SDO_POINT_TYPE(?, ?, NULL), NULL, NULL)) = 'TRUE'";
