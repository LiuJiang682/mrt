...
public class H0402Validator implements Validator {

	public static final String DESCRIPTION_TITLE = "Description";
	private static final String FIELD_NAME = "H0402";
	...
	public Optional<List<String>> validate(Map<String, List<String>> templateParamMap, Template dataBean) {
		...
		new TemplateFieldBasicValidator(strs, DESCRIPTION_TITLE, FIELD_NAME)
				.validate(messages);
		new H0400FieldsArraySizeValidator(strs, templateParamMap).validate(messages);
