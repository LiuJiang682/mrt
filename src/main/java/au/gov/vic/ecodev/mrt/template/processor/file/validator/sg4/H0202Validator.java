...
public class H0202Validator implements Validator {
	...
	private static final String DATA_FORMAT_SG4 = "sg4";
	...
	public Optional<List<String>> validate(Map<String, List<String>> templateParamMap, Template dataBean) {
		...
		if (null == strs) {
			...
			if (!DATA_FORMAT_SG4.equalsIgnoreCase(strs[Numeral.TWO])) {
				String message = "H0202 must be SG4, but got " + strs[Numeral.TWO];
				messages.add(message);
			}
