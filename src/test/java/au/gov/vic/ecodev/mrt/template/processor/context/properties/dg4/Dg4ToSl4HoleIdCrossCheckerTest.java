...
public class Dg4ToSl4HoleIdCrossCheckerTest {

	private Dg4ToSl4HoleIdCrossChecker testInstance;
	...
	public void shouldReturnFalseWhenContextSearchReturnPopulatedList() throws TemplateProcessorException {
		...
		assertThat(logMessageCaptor.getValue(), is(equalTo("Hole_id: STD001 exist in DG4 but missing in SL4")));
		...
		assertThat(capturedCriteria.getSearcherClassName(), is(equalTo(GeoChemistryHoleIdNotInBoreHoleSearcher.class.getName())));
	...
	public void shouldRaiseExceptionWhenContextIsNull() {
		...
		//When
		new Dg4ToSl4HoleIdCrossChecker(context);
		fail("Program reached unexpected point!");
	}
	
	private void givenTestInstance() {
		mockContext = Mockito.mock(TemplateProcessorContext.class);
		testInstance =  new Dg4ToSl4HoleIdCrossChecker(mockContext);
	}
}
