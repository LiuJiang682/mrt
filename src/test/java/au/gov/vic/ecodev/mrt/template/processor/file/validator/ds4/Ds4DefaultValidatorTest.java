...
public class Ds4DefaultValidatorTest {
	...
	public void shouldReturnEmptyMessageWhenStringArrayIsEof() {
		...
		params.put(Strings.KEY_H0534, Arrays.asList("Downhole_Direction_Survey_Instrument", "Single shot camera"));
		params.put(Strings.KEY_H0535, Arrays.asList("Downhole_Direction_Survey_Company", "Small Time Mining NL"));
		// When
