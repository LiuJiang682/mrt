...
public class Dg4ToSl4ToCrossCheckerTest {

	private TemplateProcessorContext mockContext;
	private Dg4ToSl4ToCrossChecker testInstance;
	...
	public void shouldReturnFalseWhenContextSearchReturnPopulatedList() throws TemplateProcessorException {
		...
		assertThat(capturedCriteria.getSearcherClassName(), is(equalTo(GeoChemistryToGtTotalDepthSearcher.class.getName())));
	...
	public void shouldRaiseExceptionWhenContextIsNull() {
		...
		//When
		new Dg4ToSl4ToCrossChecker(context);
	...
	private void givenTestInstance() {
		...
		testInstance = new Dg4ToSl4ToCrossChecker(mockContext);
	}
}
