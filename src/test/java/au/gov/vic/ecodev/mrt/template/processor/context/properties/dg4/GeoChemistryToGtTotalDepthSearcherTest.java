...
@SpringBootTest
@ActiveProfiles("test")
public class GeoChemistryToGtTotalDepthSearcherTest {
	...
	@Test
	public void shouldReturnHoleIdOfDepthToGtTotalDepth() {
		//Given
		long id = IDGenerator.getUID().longValue();
		final long LOADER_ID = 1;
		jdbcTemplate.update(INSERT_GEOCHEMISTRY_SQL, new Object[] {id, 
				LOADER_ID, "KPDD001", "ABC123", "myTest.txt", "1", 1, 300, "DD"});
		GeoChemistryToGtTotalDepthSearcher testInstance = new GeoChemistryToGtTotalDepthSearcher();
