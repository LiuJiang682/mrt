...
public class Ds4ToSl4HoleIdCrossCheckerTest {

	private TemplateProcessorContext mockContext;
	private Ds4ToSl4HoleIdCrossChecker testInstance;
	...
	public void shouldReturnFalseWhenContextSearchReturnPopulatedList() throws TemplateProcessorException {
		...
		assertThat(logMessageCaptor.getValue(), is(equalTo("Hole_id: STD001 exist in DS4 but missing in SL4")));
		...
		assertThat(capturedCriteria.getSearcherClassName(), is(equalTo(DownHoleHoleIdNotInBoreHoleSearcher.class.getName())));
	...
	private void givenTestInstance() {
		...
		testInstance = new Ds4ToSl4HoleIdCrossChecker(mockContext);
	}
}
