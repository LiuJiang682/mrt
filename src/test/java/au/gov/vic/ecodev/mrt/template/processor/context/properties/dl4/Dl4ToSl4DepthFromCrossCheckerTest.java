...
public class Dl4ToSl4DepthFromCrossCheckerTest {

	private TemplateProcessorContext mockContext;
	private Dl4ToSl4DepthFromCrossChecker testInstance;
	...
	public void shouldReturnFalseWhenContextSearchReturnPopulatedList() throws TemplateProcessorException {
		...
		//When
		boolean flag = testInstance.doDepthFromCrossCheck(1l);
		//Then
		...
		assertThat(logMessageCaptor.getValue(), is(equalTo("Hole_id: STD001 Depth_from is greater than total depth!")));
		...
		assertThat(capturedCriteria.getSearcherClassName(), is(equalTo(LithologyDepthFromGtTotalDepthSearcher.class.getName())));
	...
	public void shouldRaiseExceptionWhenContextIsNull() {
		...
		//When
		new Dl4ToSl4DepthFromCrossChecker(context);
	...
	private void givenTestInstance() {
		...
		testInstance = new Dl4ToSl4DepthFromCrossChecker(mockContext);
	}
}
