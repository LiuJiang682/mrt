...
public class Dg4ValidatorFactoryTest {

	private TemplateProcessorContext mockContext;
	private Dg4ValidatorFactory testInstance;
	...
	public void shouldReturnDs4DefaultValidator() throws Exception {
		...
		Validator validator = testInstance.getLineValidator(line);
		// Then
		assertThat(validator, is(instanceOf(Dg4DefaultValidator.class)));
	}
	...
	public void shouldRaiseExceptionWhenContextIsNull() {
		...
		// When
		new Dg4ValidatorFactory(context, mandatoryFields);
	...
	private void givenTestInstance() {
		...
		testInstance = new Dg4ValidatorFactory(mockContext, mandatoryFields);
	}
}
