...
public class Ds4ValidatorFactoryTest {
	
	private Ds4ValidatorFactory testInstance;
	...
	public void shouldReturnDs4DefaultValidator() throws Exception {
		...
		Validator validator = testInstance.getLineValidator(line);
		// Then
		assertThat(validator, is(instanceOf(Ds4DefaultValidator.class)));
	}
	...
	public void shouldRaiseExceptionWhenContextIsNull() {
		...
		// When
		new Ds4ValidatorFactory(context, mandatoryFields);
	...
	private void givenTestInstance() {
		...
		testInstance = new Ds4ValidatorFactory(mockContext, mandatoryFields);
	}
}
